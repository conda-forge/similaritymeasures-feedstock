...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/similaritymeasures-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12107&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/similaritymeasures-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `similaritymeasures` can be installed with:

```
conda install similaritymeasures
```

It is possible to list all of the versions of `similaritymeasures` available on your platform with:
